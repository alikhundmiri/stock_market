...
html_2_data = '''
	<table cellpadding="4" cellspacing="1" class="mGrid" id="ContentPlaceHolder1_gvData" width="100%">
		<tr class="pgr">
			<td colspan="10"><table>
				<tr>
...
def get_list():
	...
	dividend_table_string = str(dividend_table)

	table_data = [[cell.text for cell in row("td")]for row in BeautifulSoup(dividend_table_string, features="html.parser")("tr")]

	table_data_json = json.dumps(table_data)
	print(table_data_json)
	print("\nType table_data \t\t : {}".format(type(table_data_json)))
